...
public class CategoryController {
	...
	@GetMapping("create")
	public String create(@ModelAttribute("category") CategoryModel cate, Model model) {
		model.addAttribute("view", "/views/admin/categories/create.jsp");
		return "layout";
	}

	@PostMapping("store")
	public String store(@Valid @ModelAttribute("category") CategoryModel mol, BindingResult result, Model model) {
	...
	public String edit(@PathVariable("id") int id, Model mol) {
		...
		mol.addAttribute("view", "/views/admin/categories/edit.jsp");
		return "layout";
	}
